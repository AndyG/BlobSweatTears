...
public class SlimeWallCling : SlimeStates.SlimeState1Param<bool>
{
  ...
  private void LeaveWall(Vector2 targetVelocity)
  {
    ...
    slime.lockAirborneMovementTime = lockMovementAfterJumpTime;
  ...
  {
    // GameObject effect = GameObject.Instantiate(wallJumpEffect, slime.jumpEffectTransform.position, Quaternion.identity);
    // if (!isWallOnLeft)
    // {
